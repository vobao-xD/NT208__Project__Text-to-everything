            ...
            <div className="content">
                ...
                <div className="conversation content-item">
                    {chatHistory.map((message, index) => (
                        <div
                            key={index}
                            className={`message ${message.type}-message${message.video_url ? " video-message" : ""
                                }${message.audio_url ? " audio-message" : ""}${message.image_url ? " image-message" : ""
                                }`}
                        >
                            {message.type === "user" ? (
                                message.audio_url ? (
